...
{ word: 'carmen', hint: 'Member asal Bali, Indonesia, tertua di H2H 🇮🇩' },
{ word: 'jiwoo', hint: 'Leader Hearts2Hearts, mantan penari balet 👑' },
{ word: 'yuha', hint: 'All rounder H2H dengan trainee terlama di SM ✨' },
{ word: 'stella', hint: 'Member Kanada yang jago main drum dan gitar 🎸' },
{ word: 'juun', hint: 'Penari utama H2H, bersuara serak dan imut 🕺' },
{ word: 'ana', hint: 'Anggota H2H dengan nama panggung bermakna huruf A 🔤' },
{ word: 'ian', hint: 'Mantan model cilik yang mirip Karina aespa 👧' },
{ word: 'yeon', hint: 'Maknae termuda H2H, lahir tahun 2010 🎀' },
{ word: 'thechase', hint: 'Lagu debut pertama Hearts2Hearts dari single album berjudul sama 🎵' },
{ word: 's2u', hint: 'Nama fandom resmi Hearts2Hearts, dibaca "Hearts U" 💕' },
{ word: 'butterflies', hint: 'Singel kedua H2H setelah debut, bergenre pop ceria 🦋' },
{ word: 'focus', hint: 'Mini album pertama Hearts2Hearts yang dirilis Oktober 2025 📀' },
{ word: 'rude', hint: 'Singel tahun 2026 dengan gaya lebih berani dan enerjik 😤' },
{ word: 'smentertainment', hint: 'Agensi yang menaungi Hearts2Hearts, juga punya aespa dan NCT 🏢' },
{ word: 'mama2025', hint: 'Penghargaan Rookie of the Year yang diraih H2H di ajang tahunan ini 🏆' },
{ word: 's2u', hint: 'Nama fandom resmi mereka yang dibaca "Ha-chu" dalam bahasa Korea 💖' },
{ word: 'thechase', hint: 'Lagu debut mereka yang terinspirasi dari dunia Alice in Wonderland 🐇' },
{ word: 'butterflies', hint: 'Lagu B-side dari album debut yang menawarkan harmoni melodius yang kontras dengan lagu utama 🦋' },
{ word: 'style', hint: 'Single digital spesial yang dirilis tepat pada hari ulang tahun member Stella 🎂' },
{ word: 'focus', hint: 'Mini album (EP) pertama mereka yang dirilis pada Oktober 2025 📀' },
{ word: 'rude', hint: 'Single terbaru mereka yang dirilis pada Februari 2026 dengan gaya berani 😤' },
{ word: 'big4', hint: 'Grup ini debut di bawah agensi Korea yang masuk jajaran "Empat Besar" ini 🏢' },
{ word: 'jiwoo', hint: 'Leader yang merupakan ballerina dan satu-satunya anggota berambut pendek saat debut 💇‍♀️' },
{ word: 'carmen', hint: 'Gadis Bali yang dijuluki "Sunshine" karena kepribadiannya yang ceria ☀️' },
{ word: 'yuha', hint: 'All rounder yang ternyata punya saudara kembar yang lahir hanya 2 menit setelahnya 👯‍♀️' },
{ word: 'stella', hint: 'Member Kanada yang merupakan "Pink Princess" dan fasih berbahasa Inggris 🎸' },
{ word: 'juun', hint: 'Penari utama yang dijuluki "Super Cutie" karena memiliki "husky voice" 🗣️' },
{ word: 'ana', hint: 'Artinya "Aku adalah A di setiap hal" dan merupakan penggemar Detective Conan 🕵️' },
{ word: 'ian', hint: 'Mantan model cilik yang saat audisi menyanyikan lagu "Let It Go" dari Frozen ❄️' },
{ word: 'yeon', hint: 'Maknae yang mulai bernyanyi sejak usia 5 tahun dan direkrut lewat video orang tuanya 🎤' },
{ word: 'dm', hint: 'Cara SM Entertainment merekrut 3 member H2H melalui pesan pribadi di media sosial ini 📩' },
{ word: 'indonesiabali', hint: 'Bahasa daerah yang digunakan Carmen saat menyapa fans Indonesia, mencerminkan asal daerahnya 🗣️' },
{ word: 'bestpart', hint: 'Lagu yang dibawakan Carmen saat audisi, berhasil memukau para juri SM Entertainment 🎶' },
]
